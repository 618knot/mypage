...
<div class="w-full flex flex-col flex-1 min-h-0">
	...
	<div class="flex flex-col items-center space-y-4 w-full flex-1 overflow-y-auto pb-4 no-scrollbar">
		...
		{#if activeTab === 'event'}
			<EventLinkCard
				name="フロントエンド・PHPカンファレンス北海道2026"
				date="2026.06.06"
				url="https://fortee.jp/frontend-phpcon-do-2026"
				role="コアスタッフ"
			/>
			<EventLinkCard
				name="フロントエンドカンファレンス北海道2025"
				date="2025.09.06"
				url="https://fortee.jp/frontend-conf-hokkaido-2025"
				role="コアスタッフ"
			/>
			<EventLinkCard
				name="フロントエンドカンファレンス北海道2024"
				date="2024.08.24"
				url="https://fortee.jp/frontend-conf-hokkaido-2024"
				role="コアスタッフ"
			/>
			<EventLinkCard
				name="TechRAMEN 2024 Conference"
				date="2024.07.27"
				url="https://fortee.jp/techramen-24-conf"
				role="一般参加"
			/>
			<EventLinkCard
				name="PHPカンファレンス北海道2024"
				date="2024.01.13"
				url="https://fortee.jp/phpcon-hokkaido-2024"
				role="当日スタッフ"
			/>
		{/if}
	</div>
